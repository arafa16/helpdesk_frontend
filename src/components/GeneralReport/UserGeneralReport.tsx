      ...
      <div className="col-span-12 mt-6">
        ...
        >
          <div className="grid grid-cols-12 gap-0 py-0 divide-x divide-y box xl:py-5 xl:divide-y-0 divide-dashed divide-slate-200 dark:divide-white/5">
            {status_fake.map((status: any, index: number) => (
              <div
                className={clsx([
                ...
                <div data-content>
                  <div className="flex">
                    <div className="flex gap-x-4 items-center">
                      <div
                        className={`flex items-center justify-center border rounded-full w-[2.2rem] h-[2.2rem] text-success bg-secondary/20 border-secondary/20`}
                      >
                        <Lucide
                      ...
                      <div className="mt-1 text-slate-500">{status?.name}</div>
                    </div>
