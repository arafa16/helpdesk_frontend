...
const DataDivisionPage = () => {
  ...
  useEffect(() => {
    ...
    dispatch(GetDivisionData(params_attributes));
  }, [dispatch, meta]);
  ...
  const handleView = (data: any) => {
    ...
    navigate(`/division/view/${data.uuid}?${back}`);
  };
...
export default DataDivisionPage;
