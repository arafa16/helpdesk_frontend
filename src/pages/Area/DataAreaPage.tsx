...
import { GetAreaData, resetArea } from "../../stores/features/AreaSlice";
...
const DataAreaPage = () => {
  ...
  useEffect(() => {
    ...
    dispatch(GetAreaData(params_attributes));
  }, [dispatch, meta]);
  ...
  const handleView = (data: any) => {
    ...
    navigate(`/area/view/${data.uuid}?${back}`);
  };

  const handleSearch = (search: string) => {
    setMeta({ ...meta, area_uuid: "", search });
    if (meta.page !== 1) {
