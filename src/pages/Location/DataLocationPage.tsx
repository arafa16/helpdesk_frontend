...
const DataLocationPage = () => {
  ...
  useEffect(() => {
    ...
    dispatch(GetLocationData(params_attributes));
  }, [dispatch, meta]);
  ...
  const handleView = (data: any) => {
    ...
    navigate(`/location/view/${data.uuid}?${back}`);
  };
...
export default DataLocationPage;
